...
from HOKAGE import BOT_USERNAME, OWNER_ID
from HOKAGE import OWNER_USERNAME as AK_BOSS
from HOKAGE import arq, pgram
from HOKAGE.utils.pluginhelpers import convert_seconds_to_minutes as time_convert
from HOKAGE.utils.pluginhelpers import fetch
...
async def inline_help_func(__HELP__):
    ...
    answerss = [
        InlineQueryResultArticle(
            ...
            thumb_url="https://te.legra.ph/file/d67c68b5ad7523f738e41.jpg",
...
**ᴘʀᴏғɪʟᴇs:** [ʙᴏᴛ](t.me/{BOT_USERNAME}) | [ᴏᴡɴᴇʀ](t.me/Mr_DiSasTer_XD)
"""
    answers.append(
        InlineQueryResultArticle(
            title="ᴀʟɪᴠᴇ",
