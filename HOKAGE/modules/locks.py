...
import MakimaRobot.modules.sql.locks_sql as sql
from MakimaRobot import DRAGONS, LOGGER, dispatcher
from MakimaRobot.modules.connection import connected
from MakimaRobot.modules.disable import DisableAbleCommandHandler
from MakimaRobot.modules.helper_funcs.alternate import send_message, typing_action
from MakimaRobot.modules.helper_funcs.chat_status import (
    can_delete,
    is_bot_admin,
    is_user_admin,
    user_admin,
...
from MakimaRobot.modules.log_channel import loggable
from MakimaRobot.modules.sql.approve_sql import is_approved
